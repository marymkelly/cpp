const SagaLogoWhite = (props) => {
	return (
		<svg
			...
			<defs>
				<linearGradient id='linear-gradient' x1='.2' y1='101.78' x2='594.32' y2='101.78' gradientUnits='userSpaceOnUse'>
				...
				<linearGradient id='linear-gradient-2' x1='132.63' y1='117.83' x2='183.58' y2='117.83' gradientUnits='userSpaceOnUse'>
				...
				<linearGradient id='linear-gradient-3' x1='-2.85' y1='176.88' x2='144.07' y2='132.07' gradientUnits='userSpaceOnUse'>
					<stop offset='0' stopColor='#f5fcfc' stopOpacity='0' />
					<stop offset='.1' stopColor='#effbfa' stopOpacity='.02' />
					<stop offset='.21' stopColor='#e0faf7' stopOpacity='.07' />
					<stop offset='.32' stopColor='#c6f9f0' stopOpacity='.15' />
					<stop offset='.43' stopColor='#a3f7e8' stopOpacity='.27' />
					<stop offset='.45' stopColor='#9af7e6' stopOpacity='.3' />
					<stop offset='.48' stopColor='#94f4e3' stopOpacity='.33' />
					<stop offset='.76' stopColor='#5ae0c6' stopOpacity='.67' />
...
const SagaLogoBlack = (props) => {
	return (
		<svg
			...
			className={props.className}>
			<defs>
				<linearGradient id='linear-gradient' x1='.06' y1='101.79' x2='594.32' y2='101.79' gradientUnits='userSpaceOnUse'>
					<stop offset='0' stopColor='#000' />
					<stop offset='0' stopColor='#041513' />
					<stop offset='.01' stopColor='#09352e' />
					<stop offset='.02' stopColor='#0e5046' />
				...
				<linearGradient id='linear-gradient-2' x1='132.57' y1='117.83' x2='183.52' y2='117.83' gradientUnits='userSpaceOnUse'>
				...
				<linearGradient id='linear-gradient-3' x1='-2.91' y1='176.88' x2='144.01' y2='132.07' gradientUnits='userSpaceOnUse'>
...
function SagaLogo({ theme, className }) {
	return theme === "dark" ? <SagaLogoWhite className={className} /> : <SagaLogoBlack className={className} />;
}
